...
% This file calls filter_ten_c_call
...
slider_1=uicontrol('style','slider','units','normalized','pos',[0.65 0.90 0.19 0.028],...
         ...
         'callback',['freq=0.01*round(100*get(slider_1,''value''));',...
             ...
             'set(gca,''view'',[0 0.5]),',...
             'filter_ten_c_call(freq,flag1,flag2)']);
...
h30=uicontrol('style','pushbutton','string','SLIDER','units','normalized',...
    'position',[0.6 0.830 0.055 0.030],'callback',['flag1=1;','filter_ten_c_call(freq,flag1,flag2)']);
h40=uicontrol('style','pushbutton','string','SWEEP','units','normalized',...
    'position',[0.67 0.830 0.055 0.030],'callback',['flag1=0;','filter_ten_c_call(freq,flag1,flag2)']);
h50=uicontrol('style','pushbutton','string','TIME','units','normalized',...
    'position',[0.74 0.830 0.055 0.030],'callback',['flag2=1;','filter_ten_c_call(freq,flag1,flag2)']);
h60=uicontrol('style','pushbutton','string','FREQ','units','normalized',...
    'position',[0.81 0.830 0.055 0.030],'callback',['flag2=0;','filter_ten_c_call(freq,flag1,flag2)']);
