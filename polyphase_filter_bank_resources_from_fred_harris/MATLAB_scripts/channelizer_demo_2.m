...
hold on
fh=fftshift(20*log10(abs(fft(h/30,4096))));
plot(1+(-0.5:1/4096:0.5-1/4096)*30,fh,'r')
plot(-8+(-0.5:1/4096:0.5-1/4096)*30,fh,'r')
plot(-9+(-0.5:1/4096:0.5-1/4096)*30,fh,'r')
plot(-10+(-0.5:1/4096:0.5-1/4096)*30,fh,'r')
...
%%%%%%%%%%%%%%%% repeat channelizer but now with signals with bandwidth
% narrow band signals with BW = 1/4 sampled at 30 

g1=sinc(-5:1/4:5).*kaiser(41,8)'; %Shaping filter, 4-samples per symbol
g1=[g1 0 0 0];
xx1=zeros(5,1800);
frq=[-6 -2 1 3 7];
xx4=zeros(5,2400);
