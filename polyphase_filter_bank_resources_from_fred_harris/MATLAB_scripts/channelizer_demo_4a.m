...
grid on
axis([-4 4 -0.3 1.2])
title('Impulse Response, 269-Tap Prototype Nyquist Filter for 30-Path Synthesis Channelizer, 10-Taps per Path')
xlabel('Time Index')
ylabel('Amplitude')
...
figure(5)
subplot(4,1,1)
plot(0:519,real(x2),'r','linewidth',2)
grid on
axis([0 450 -0.2 0.8])
title('Impulse Response Cascade Polyphase Filter Banks, 64 M&A per Outpoit Sample')
ylabel('Amplitude')
...
grid on
axis([0 450 -0.2 0.8])
title('Impulse Response 239-Tap FIR Filter, 239 M&A Per Output Sample')
ylabel('Amplitude')
xlabel('Time Index')
