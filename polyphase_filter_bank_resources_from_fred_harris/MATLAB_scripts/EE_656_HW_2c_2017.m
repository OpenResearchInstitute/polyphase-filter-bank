% N1=(36/2)*80/22 =65
h0=remez(64,[0 1 3 18]/18,{'myfrf',[1 1 0 0]},[1 120]);
f1=1;
f2=3;
figure(1)
subplot(3,1,1)
...
for k=1:6
subplot(3,3,k)
plot(real(v1(k,:)),'linewidth',2.5)
hold on
plot(imag(v1(k,:)),'r','linewidth',2.5)
hold off
grid on
...
plot((-0.5:1/128:0.5-1/128)*6,fx1,'linewidth',2.5)
grid on
axis([-3 3 -100 10])
...
hold on
for k=1:6
    plot(fftshift((fft(v1(k,21:148)/256))),'-o','linewidth',2.5);
end
hold off
grid on
axis('square')
