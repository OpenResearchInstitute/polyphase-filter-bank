function filter_ten_c_call(freq,flag1,flag2)
% Script file called by filter_ten_c to animate 
...
if flag2==1
    ...
    ww=kaiser(100,6)';
    ww=ww/sum(ww);
    hp=remez(99,[0 60 80 500]/500,[1 1 0 0],[1 1]);
    ...
    plot(-0.5:1/100:.5-1/100,0.9*[fhp(11:100) fhp(1:10)],'b--')
    plot(-0.5:1/100:.5-1/100,    [fhp(21:100) fhp(1:20)],'r--')
    plot(-0.5:1/100:.5-1/100,0.9*[fhp(31:100) fhp(1:30)],'b--')
    plot(-0.5:1/100:.5-1/100,    [fhp(41:100) fhp(1:40)],'r--')
    plot(-0.5:1/100:.5-1/100,0.9*[fhp(51:100) fhp(1:50)],'b--')
    plot(-0.5:1/100:.5-1/100,    [fhp(61:100) fhp(1:60)],'r--')
    plot(-0.5:1/100:.5-1/100,0.9*[fhp(71:100) fhp(1:70)],'b--')
    plot(-0.5:1/100:.5-1/100,    [fhp(81:100) fhp(1:80)],'r--')
    plot(-0.5:1/100:.5-1/100,0.9*[fhp(91:100) fhp(1:90)],'b--')
...
frq=[0 60 80 99 100 149 150 199 200 249 250 299 300 349 350 399 400 449 450 500]/500;
